...
// Types
export type xwragNodeType = {
  id: string
  labels: string[]
  properties: Record<string, any>
}

export type xwragEdgeType = {
  id: string
  source: string
  target: string
  type: string
...
export type xwragGraphType = {
  nodes: xwragNodeType[]
  edges: xwragEdgeType[]
}

export type xwragStatus = {
  status: 'healthy'
...
export type xwragDocumentsScanProgress = {
  is_scanning: boolean
  current_file: string
...
export const checkHealth = async (): Promise<
  xwragStatus | { status: 'error'; message: string }
> => {
  try {
...
export const getDocumentsScanProgress = async (): Promise<xwragDocumentsScanProgress> => {
