...
from xwrag.namespace import NameSpace
from xwrag.operate import (
...
from xwrag.types import KnowledgeGraph
...
class xwrag:
    ...
    # TODO: Deprecated (xwrag will never initialize storage automatically on creation，and finalize should be call before destroying)
    auto_manage_storages_states: bool = field(default=False)
    """If True, xwrag will automatically calls initialize_storages and finalize_storages at the appropriate times."""
    ...
    def __post_init__(self):
        ...
        logger.debug(f"xwrag init with param:\n  {_print_config}\n")
    ...
    def _get_storage_class(self, storage_name: str) -> Callable[..., Any]:
        ...
        if storage_name == "JsonKVStorage":
            from xwrag.kg.json_kv_impl import JsonKVStorage

            return JsonKVStorage
        elif storage_name == "NanoVectorDBStorage":
            from xwrag.kg.nano_vector_db_impl import NanoVectorDBStorage

            return NanoVectorDBStorage
        elif storage_name == "NetworkXStorage":
            from xwrag.kg.networkx_impl import NetworkXStorage

            return NetworkXStorage
        elif storage_name == "JsonDocStatusStorage":
            from xwrag.kg.json_doc_status_impl import JsonDocStatusStorage
    ...
    async def aquery(
        ...
        # --- 将结果写入文件 ---
        # 1. 定义要保存的文件名
        output_filename = "llm_result.txt"
    ...
    async def adelete_by_entity(self, entity_name: str) -> DeletionResult:
        ...
        Returns:
            DeletionResult: An object containing the outcome of the deletion process.
        """
        from xwrag.utils_graph import adelete_by_entity
    ...
    async def adelete_by_relation(
        ...
        Returns:
            DeletionResult: An object containing the outcome of the deletion process.
        """
        from xwrag.utils_graph import adelete_by_relation
    ...
    async def get_entity_info(
        ...
        from xwrag.utils_graph import get_entity_info
    ...
    async def get_relation_info(
        ...
        from xwrag.utils_graph import get_relation_info
    ...
    async def aedit_entity(
        ...
        """
        from xwrag.utils_graph import aedit_entity
    ...
    async def aedit_relation(
        ...
        """
        from xwrag.utils_graph import aedit_relation
    ...
    async def acreate_entity(
        ...
        """
        from xwrag.utils_graph import acreate_entity
    ...
    async def acreate_relation(
        ...
        """
        from xwrag.utils_graph import acreate_relation
    ...
    async def amerge_entities(
        ...
        """
        from xwrag.utils_graph import amerge_entities
    ...
    async def aexport_data(
        ...
        """
        from xwrag.utils import aexport_data as utils_aexport_data
