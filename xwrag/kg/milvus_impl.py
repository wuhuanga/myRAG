...
class MilvusVectorDBStorage(BaseVectorStorage):
    def _create_schema_for_namespace(self) -> CollectionSchema:
        ...
        if self.namespace.endswith("entities"):
            ...
            description = "xwrag entities vector storage"
            ...
            description = "xwrag relationships vector storage"
            ...
            description = "xwrag chunks vector storage"
            ...
            description = "xwrag generic vector storage"
