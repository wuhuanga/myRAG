"""
Utility functions for the xwrag API.
"""
...
from xwrag.api import __api_version__ as api_version
from xwrag import __version__ as core_version
...
def display_splash_screen(args: argparse.Namespace) -> None:
    """
    Display a colorful splash screen showing xwrag server configuration
    ...
    line1_text = f"xwrag Server v{core_version}/{api_version}"
    ...
    ASCIIColors.yellow(f"{ollama_server_infos.xwrag_MODEL}")
