"""
Centralized configuration constants for xwrag.

This module defines default values for configuration constants used across
different parts of the xwrag system. Centralizing these values ensures
