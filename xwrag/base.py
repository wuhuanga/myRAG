...
class OllamaServerInfos:
    def __init__(self, name=None, tag=None):
        self._xwrag_name = name or os.getenv(
            "OLLAMA_EMULATING_MODEL_NAME", DEFAULT_OLLAMA_MODEL_NAME
        )
        self._xwrag_tag = tag or os.getenv(
            "OLLAMA_EMULATING_MODEL_TAG", DEFAULT_OLLAMA_MODEL_TAG
        )
        self.xwrag_SIZE = DEFAULT_OLLAMA_MODEL_SIZE
        self.xwrag_CREATED_AT = DEFAULT_OLLAMA_CREATED_AT
        self.xwrag_DIGEST = DEFAULT_OLLAMA_DIGEST

    @property
    def xwrag_NAME(self):
        return self._xwrag_name

    @xwrag_NAME.setter
    def xwrag_NAME(self, value):
        self._xwrag_name = value

    @property
    def xwrag_TAG(self):
        return self._xwrag_tag

    @xwrag_TAG.setter
    def xwrag_TAG(self, value):
        self._xwrag_tag = value

    @property
    def xwrag_MODEL(self):
        return f"{self._xwrag_name}:{self._xwrag_tag}"
