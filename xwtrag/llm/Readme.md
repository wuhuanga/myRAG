...
1. **LlamaIndex** (`llm/llama_index.py`):
   ...
   - See example implementations:
     - [Direct OpenAI Usage](../../examples/xwrag_llamaindex_direct_demo.py)
     - [LiteLLM Proxy Usage](../../examples/xwrag_llamaindex_litellm_demo.py)

<details>
<summary> <b>Using LlamaIndex</b> </summary>

xwrag supports LlamaIndex for embeddings and completions in two ways: direct OpenAI usage or through LiteLLM proxy.
