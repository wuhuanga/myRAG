# xwrag 3D Graph Viewer

An interactive 3D graph visualization tool included in the xwrag package for visualizing and analyzing RAG (Retrieval-Augmented Generation) graphs and other graph structures.
...
### Quick Install
```bash
pip install xwrag-hku[tools]  # Install with visualization tool only
# or
pip install xwrag-hku[api,tools]  # Install with both API and visualization tools
```
...
1. **Command Not Found**
   ...
   pip install xwrag-hku[tools]

   # Verify installation
   pip list | grep xwrag-hku
   ```
...
- GitHub Issues: [xwrag Repository](https://github.com/HKUDS/xwrag)
- Documentation: [xwrag Docs](https://URL-to-docs)

## License

This tool is part of xwrag and is distributed under the MIT License. See `LICENSE` for more information.

Note: This visualization tool is an optional component of the xwrag package. Install with the [tools] option to access the viewer functionality.
