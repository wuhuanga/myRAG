#!/usr/bin/env python
"""
Start xwrag server with Gunicorn
"""
...
from xwrag.api.utils_api import display_splash_screen, check_env_file
from xwrag.api.config import global_args
from xwrag.utils import get_env_value
from xwrag.kg.shared_storage import initialize_share_data, finalize_share_data
...
def main():
    ...
    print("🚀 Starting xwrag with Gunicorn")
    ...
    class GunicornApp(BaseApplication):
        ...
        def load_config(self):
            ...
            from xwrag.api import gunicorn_config
        ...
        def load(self):
            ...
            from xwrag.api.xwrag_server import get_application
    ...
    if workers_count > 1:
        ...
        os.environ["xwrag_MAIN_PROCESS"] = "1"
